...
<div class="container">
   ...
   <div class="row">
      ...
      <div class="col-md-8" >
	 <center> 
	 <img src="Event/Public/123.jpg"  width=100px; class="img-circle"></center>
   </br>
  ...
  margin: 40px 0 0;
  background: #fff;">
	<h3 class="title"> <a href="Home_index_show_<?php echo $data['title']?>.html"></a><?php echo $data['title']?></h3>
